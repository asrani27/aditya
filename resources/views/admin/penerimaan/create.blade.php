...
@section('title', 'Tambah Penerimaan Dana')
...
<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex items-center mb-2">
            ...
            <h1 class="text-2xl font-bold text-slate-800">Tambah Penerimaan Dana Baru</h1>
        </div>
        <p class="text-slate-600">Tambahkan data penerimaan dana baru</p>
    </div>
        ...
        <form action="{{ route('admin.penerimaan.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="no_kwitansi" id="no_kwitansi" value="{{ old('no_kwitansi') }}"
                ...
                <div>
                    ...
                    <input type="number" name="dana_diterima" id="dana_diterima" value="{{ old('dana_diterima') }}"
                        min="0"
