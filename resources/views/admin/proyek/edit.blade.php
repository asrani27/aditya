...
<div class="p-6">
    ...
    <div class="mb-6">
        ...
        <p class="text-slate-600">Edit data proyek: {{ $proyek->nama_proyek }}</p>
    </div>
        ...
        <form action="{{ route('admin.proyek.update', $proyek->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="kode_proyek" id="kode_proyek" value="{{ old('kode_proyek', $proyek->kode_proyek) }}"
                ...
                <div>
                    ...
                    <select name="customer_id" id="customer_id"
                        ...
                        @foreach($customers as $customer)
                            <option value="{{ $customer->id }}" {{ old('customer_id', $proyek->customer_id) == $customer->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input type="text" name="nama_proyek" id="nama_proyek" value="{{ old('nama_proyek', $proyek->nama_proyek) }}"
                ...
                <div>
                    ...
                    <input type="number" name="nilai_kontrak" id="nilai_kontrak" value="{{ old('nilai_kontrak', $proyek->nilai_kontrak) }}" min="0"
                ...
                <div>
                    ...
                    <select name="status" id="status"
                        ...
                        <option value="Dibatalkan" {{ old('status', $proyek->status) == 'Dibatalkan' ? 'selected' : '' }}>Dibatalkan</option>
                    </select>
                    @error('status')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" name="progress" id="progress" value="{{ old('progress', $proyek->progress) }}" min="0" max="100"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="3"
                        ...
                        placeholder="Masukkan deskripsi (opsional)">{{ old('deskripsi', $proyek->deskripsi) }}</textarea>
                    @error('deskripsi')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
