...
<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex items-center mb-2">
            ...
            <h1 class="text-2xl font-bold text-slate-800">Edit Pegawai</h1>
        </div>
        <p class="text-slate-600">Edit data pegawai: {{ $pegawai->nama }}</p>
    </div>
        ...
        <form action="{{ route('admin.pegawai.update', $pegawai->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="telp" id="telp" value="{{ old('telp', $pegawai->telp) }}"
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_bekerja" id="tanggal_bekerja" value="{{ old('tanggal_bekerja', $pegawai->tanggal_bekerja->format('Y-m-d')) }}"
