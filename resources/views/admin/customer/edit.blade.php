...
<div class="p-6">
    ...
    <div class="mb-6">
        ...
        <p class="text-slate-600">Edit data customer: {{ $customer->nama_customer }}</p>
    </div>
        ...
        <form action="{{ route('admin.customer.update', $customer->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="kode_customer" id="kode_customer" value="{{ old('kode_customer', $customer->kode_customer) }}"
                ...
                <div>
                    ...
                    <input type="text" name="nama_customer" id="nama_customer" value="{{ old('nama_customer', $customer->nama_customer) }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="alamat" id="alamat" rows="2"
                        ...
                        placeholder="Masukkan alamat (opsional)">{{ old('alamat', $customer->alamat) }}</textarea>
                    @error('alamat')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="keterangan" id="keterangan" rows="3"
                        ...
                        placeholder="Masukkan keterangan (opsional)">{{ old('keterangan', $customer->keterangan) }}</textarea>
                    @error('keterangan')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
