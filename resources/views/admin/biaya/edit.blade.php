...
<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex items-center mb-2">
            ...
            <h1 class="text-2xl font-bold text-slate-800">Edit Biaya</h1>
        </div>
        <p class="text-slate-600">Edit data biaya: {{ $biaya->nama }}</p>
    </div>
        ...
        <form action="{{ route('admin.biaya.update', $biaya->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="kode" id="kode" value="{{ old('kode', $biaya->kode) }}"
                ...
                <div>
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama', $biaya->nama) }}"
                ...
                <div>
                    ...
                    <input type="number" name="harga" id="harga" value="{{ old('harga', $biaya->harga) }}" min="0"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="3"
                        ...
                        placeholder="Masukkan deskripsi (opsional)">{{ old('deskripsi', $biaya->deskripsi) }}</textarea>
                    @error('deskripsi')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
